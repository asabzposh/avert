...
describe('registration and functionality', () => {
    ...
    it('registers with error if invalid options', async () => {
        ...
        try {
            ...
            await server.register({ plugin: Avert, options: { something: 'value' } });
        }
        catch (err) {
            expect(err).to.exist();
        }
    ...
    it('can be disabled per route', async () => {
        ...
        try {
            ...
            await server.register({ plugin: Avert, options: { removeNonExistent: true } });
            ...
            // Part 2
            request = { method: 'POST', url: '/disabled', payload: { a: '', b: '', c: 'c' } };
    ...
    it('removes empties', async () => {
        ...
        try {
            ...
            request = { method: 'POST', url: '/payloadTest', payload: { a: '', b: '', c: 'c' } };
            res = await server.inject(request);
    ...
    it('removes empties on a per route basis', async () => {
        ...
        try {
            ...
            // Part 1
            let request = { method: 'GET', url: '/queryTestPerRoute?a=&b=&c=c' };
            let res = await server.inject(request);
            ...
            // Part 2
            request = { method: 'POST', url: '/payloadTestPerRoute', payload: { a: '', b: '', c: 'c' } };
            res = await server.inject(request);
    ...
    it('removes whitespaces', async () => {
        ...
        try {
            await server.register({ plugin: Avert, options: { removeWhitespace: true } });

            server.route(routes);

            // Part 1
            let request = { method: 'GET', url: '/queryTest?a=%20%20%20&b=%20%20%20&c=c' };
            let res = await server.inject(request);
            ...
            // Part 2
            request = { method: 'GET', url: '/paramsTest/' + encodeURIComponent('      ') + '/5' };
            res = await server.inject(request);
    ...
    it('removes whitespaces on a per route basis', async () => {
        ...
        try {
            ...
            // Part 1
            let request = { method: 'GET', url: '/queryTestPerRoute?a=%20%20%20&b=%20%20%20&c=c' };
            let res = await server.inject(request);
            ...
            // Part 2
            request = { method: 'GET', url: '/paramsTestPerRoute/' + encodeURIComponent('      ') + '/c' };
            res = await server.inject(request);
    ...
    it('removes dollar sign', async () => {
        ...
        try {
            await server.register({ plugin: Avert, options: { removeDollarSign: true } });
            ...
            // Part 3
            request = { method: 'POST', url: '/payloadTest', payload: { a: '$BTC', b: '$', c: 'c' } };
            res = await server.inject(request);
    ...
    it('removes dollar sign on a per route basis', async () => {
        ...
        try {
            ...
            // Part 1
            let request = { method: 'GET', url: '/queryTestPerRoute?a=$aad&b=$&c=BTC' };
            let res = await server.inject(request);
            ...
            // Part 2
            request = { method: 'GET', url: '/paramsTestPerRoute/' + encodeURIComponent('$') + '/5' };
            res = await server.inject(request);
            ...
            // Part 3
            request = { method: 'POST', url: '/payloadTestPerRoute', payload: { a: '$BTC', b: '$', c: 'c' } };
            res = await server.inject(request);
    ...
    it('escapes dollar sign', async () => {
        ...
        try {
            await server.register({ plugin: Avert, options: { escapeDollarSign: true } });
    ...
    it('chooses to remove dollar sign with both remove & escape options are given', async () => {
        ...
        try {
            await server.register({ plugin: Avert, options: { removeDollarSign: true, escapeDollarSign: true } });
    ...
    it('removes curly brackets', async () => {
        ...
        try {
            await server.register({ plugin: Avert, options: { removeCurlyBracket: true } });

            server.route(routes);

            // Part 1
            let request = { method: 'GET', url: '/queryTest?a={aa}d}&b={}&c=BTC' };
            let res = await server.inject(request);
    ...
    it('removes curly bracket on a per route basis', async () => {
        ...
        try {
            ...
            // Part 1
            let request = { method: 'GET', url: '/queryTestPerRoute?a={aa}d}&b={}&c=BTC' };
            let res = await server.inject(request);
    ...
    it('escapes curly bracket', async () => {
        ...
        try {
            await server.register({ plugin: Avert, options: { escapeCurlyBracket: true } });
            ...
            expect(res.statusCode).to.equal(200);
            expect(res.result).to.equal({ a: '\\{aa\\}d\\}', b: '\\{\\}', c: 'BTC' });
    ...
    it('chooses to remove curly bracket when both remove & escape options are given', async () => {
        ...
        try {
            await server.register({ plugin: Avert, options: { removeCurlyBracket: true, escapeCurlyBracket: true } });
    ...
    it('sanitizes on global coverage', async () => {
        ...
        try {
            await server.register({ plugin: Avert, options: { avertQuery: true, avertParams: true, avertPayload: true } });

            server.route(routes);

            // Part 1
            let request = { method: 'GET', url: '/queryTest?a=' + encodeURIComponent('<b>hello <i>world</i><script src=foo.js></script></b>') };
            let res = await server.inject(request);
            ...
            // Part 2
            request = { method: 'GET',  url: '/paramsTest/' + encodeURIComponent('<b>hello <i>world</i><script src=foo.js></script></b>') };
            res = await server.inject(request);
            ...
            // Part 3
            request = { method: 'POST', url: '/payloadTest', payload: { a: '<b>hello <i>world</i><script src=foo.js></script></b>' } };
            res = await server.inject(request);
    ...
    it('sanitizes on a per route basis', async () => {
        ...
        try {
            ...
            // Part 1
            let request = { method: 'GET', url: '/queryTestPerRoute?a=' + encodeURIComponent('<b>hello <i>world</i><script src=foo.js></script></b>') };
            let res = await server.inject(request);
            ...
            // Part 2
            request = { method: 'GET',  url: '/paramsTestPerRoute/' + encodeURIComponent('<b>hello <i>world</i><script src=foo.js></script></b>') };
            res = await server.inject(request);
            ...
            // Part 3
            request = { method: 'POST', url: '/payloadTestPerRoute', payload: { a: '<b>hello <i>world</i><script src=foo.js></script></b>' } };
            res = await server.inject(request);
    ...
    it('accepts custom generic sanitizer', async () => {
        ...
        try {
            ...
            // Part 3
            request = { method: 'POST', url: '/payloadTest', payload: { a: 'a', b: 'b', c: 'c' } };
            res = await server.inject(request);
    ...
    it('accepts generic sanitizer on a per route basis', async () => {
        ...
        try {
            ...
            // Part 1
            let request = { method: 'GET', url: '/queryTestPerRoute?a=a&b=b&c=c' };
            let res = await server.inject(request);
            ...
            // Part 3
            request = { method: 'POST', url: '/payloadTestPerRoute', payload: { a: 'a', b: 'b', c: 'c' } };
            res = await server.inject(request);
